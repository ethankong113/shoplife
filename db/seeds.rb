...
Product.create({productname: "Talking Watch", description: "A fine watch from Talking", img_url: "https://res.cloudinary.com/dmvxkwwde/image/upload/v1481657842/watch_vbake9.jpg", shop_id: Shop.find_by_shopname("The Watch Store").id, price: 200})
Product.create({productname: "Emporio Armani Black Watch", description: "A classic black watch from Emporio Armani", img_url: "https://res.cloudinary.com/dmvxkwwde/image/upload/v1481657842/emprorio_watch_g9kihv.jpg", shop_id: Shop.find_by_shopname("The Watch Store").id, price: 1000})
...
Product.create({productname: "Seiko Steel Watch", description: "Stainless Steel from Seiko", img_url: "https://res.cloudinary.com/dmvxkwwde/image/upload/v1483757548/product/bfe8968cc7cd87ce3264929960474486.jpg", shop_id: Shop.find_by_shopname("The Watch Store").id, price: 999})
...
Product.create({productname: "Timberlank Black Sneakers", description: "Black Sneakers from Timeberland. Durable.", img_url: "https://res.cloudinary.com/dmvxkwwde/image/upload/v1483757937/product/3b102470852e77195bfa054407fbe9e1.jpg", shop_id: Shop.find_by_shopname("Nice Shoes There").id, price: 550})
